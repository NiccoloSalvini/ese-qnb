...
\newcommand{\paperframe}[2]{% #1 drills, #2 minutes
  ...
  \begin{frame}[plain]
    ...
    {\Large #1}\par\vspace{0.6em}{#2 minutes. Show all work, exam style. Tutor circulates.}
  \end{frame}}}
\newcommand{\clipframe}[3]{% #1 image basename, #2 overlay count spec, #3 mp4 name
  ...
  \begin{frame}[plain]
    \centering #2
    \vspace{-0.2em}\par{\footnotesize \href{run:../../anim/out/#3}{$\blacktriangleright$ play \texttt{\detokenize{#3}}} \quad (frames rendered with manim from \texttt{anim/src/week01\_scenes.py})}
  \end{frame}}}
...
\begin{frame}{Where the first five weeks go}
  ...
  \begin{column}{0.58\textwidth}
    ...
    1 & 23 Sep & equations, systems, quadratics, logs \\
    2 & 30 Sep & read a function; limits; the derivative \\
    3 & 7 Oct & study a function; optimise; integrate \\
    4 & 14 Oct & interest, discounting, NPV \\
    5 & 21 Oct & bonds, duration, convexity; mock exam \\ \bottomrule
    \end{tabular}
  \end{column}
...
\clipframe{w01_parabola}{%
  \only<1>{\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{../../anim/frames/w01_parabola_1.png}}%
  \only<2>{\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{../../anim/frames/w01_parabola_2.png}}%
  \only<3>{\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{../../anim/frames/w01_parabola_3.png}}%
  \only<4>{\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{../../anim/frames/w01_parabola_4.png}}}{w01_parabola.mp4}
...
\clipframe{w01_growth}{%
  \only<1>{\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{../../anim/frames/w01_growth_1.png}}%
  \only<2>{\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{../../anim/frames/w01_growth_2.png}}%
  \only<3>{\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{../../anim/frames/w01_growth_3.png}}}{w01_growth.mp4}
...
\begin{frame}{Take home}
  ...
  \end{enumerate}
  \vspace{0.8em}
  \textbf{Homework 1} (\texttt{homework.md}), due Tuesday 29 Sep 23:59 on Moodle: eight drills on paper + a 150--250-word memo to the Board on the profitable window.\\[0.6em]
