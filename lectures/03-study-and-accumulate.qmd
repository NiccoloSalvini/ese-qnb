...
## Homework 2, at the board {.paper background-color="#eceff0"}
...
::: {.blocks}
::: {.blk .recap}
[Block A]{.blk-letter}What a function is, once you have to use one[Domain first, always — written as an interval]{.blk-answer}
:::
::: {.blk .recap}
[Block B]{.blk-letter}What happens near a point you cannot reach[0/0 → factor, cancel, substitute. Average cost falls towards €400, never below]{.blk-answer}
:::
::: {.blk .recap}
[Block C]{.blk-letter}What does one more bike do to profit?[$\pi'(q) = -8q + 1200$: the 81st bike adds €560; zero at 150]{.blk-answer}
:::
::: {.blk .recap}
[Block D]{.blk-letter}From the marginal back to the total[Integrate, add + C, pin C with one known value]{.blk-answer}
:::
:::

[Today the pieces become one procedure: the full study of a function — the whole midterm.]{.red}
...
## Three blocks today, then the quiz {.hub auto-animate=true}

::: {.blocks}
::: {.blk .now data-id="blkA"}
[Block A]{.blk-letter}The study, done properly[the seven steps]{.blk-tool}
:::
::: {.blk .next}
[Block B]{.blk-letter}How much should the firm produce?[optimisation · MR = MC]{.blk-tool}
:::
::: {.blk .next}
[Block C]{.blk-letter}What did all of them add up to?[integration]{.blk-tool}
:::
:::

## [Block A]{.section-kicker} The study, done properly {.section-slide background-color="#AF1F25" auto-animate=true}
...
## [Block B]{.section-kicker} Optimisation, and what it is for {.section-slide background-color="#AF1F25" auto-animate=true}
...
## [Block C]{.section-kicker} Integration — adding up the marginal {.section-slide background-color="#AF1F25" auto-animate=true}
