...
## [Block A]{.section-kicker} Pricing a bond — nothing new {.section-slide background-color="#AF1F25"}
...
## [Block B]{.section-kicker} Duration — the slope of that curve {.section-slide background-color="#AF1F25"}
...
<video class="clipvideo" width="1000" height="562" controls preload="metadata" poster="media/w05_duration_poster.png"><source src="media/w05_duration.mp4" type="video/mp4"></video>
...
## [Block C]{.section-kicker} Convexity — the gap the line misses {.section-slide background-color="#AF1F25"}
...
<video class="clipvideo" width="1000" height="562" controls preload="metadata" poster="media/w05_convexity_poster.png"><source src="media/w05_convexity.mp4" type="video/mp4"></video>
...
## [Block D]{.section-kicker} Mock exam — the final's calculus question {.section-slide background-color="#AF1F25"}
