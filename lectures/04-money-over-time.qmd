...
:::
::: {.blk .next}
[Block C]{.blk-letter}What is a future euro worth today?[discounting · annuities]{.blk-tool}
:::
::: {.blk .next}
...
## [Block C]{.section-kicker} Discounting — running the clock backwards {.section-slide background-color="#AF1F25" auto-animate=true}
